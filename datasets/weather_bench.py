...
class WeatherDataset:
    ...
    def load(self, variables = HAS_LEVEL_VARIABLE + NONE_LEVEL_VARIABLE, latitude: Tuple | None = None, longitude=None):
    ...
    def load_data(self, dataset:xr.Dataset, variables) -> Tuple[torch.Tensor, torch.Tensor]:
        start = time.time()
        result = {}
