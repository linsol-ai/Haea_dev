...
class WeatherDataset:
    ...
    def __init__(self, start_date: datetime.datetime, end_date: datetime.datetime, device: torch.device, normalize=True, offline=True):
    ...
    def check_dataset(self, start_date: datetime.datetime, end_date):
