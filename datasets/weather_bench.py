...
class WeatherDataset:
    ...
    DATE_OFFSET = [(2021, 2018), (2018, 2013), (2013, 2008), (2008, 2003)]
    ...
    def __init__(self, year_offset:int, device:torch.device):
        ...
        dataset_urls = [
            ...
            f'gs://era5_preprocess/240x121/{start}-12-31_{end}-12-31.zarr',
            f'gs://era5_preprocess/64x32/{start}-12-31_{end}-12-31.zarr'
        ]
