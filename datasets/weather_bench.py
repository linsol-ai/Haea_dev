...
class WeatherDataset:
    ...
    SURFACE_VARIABLE = ['2m_temperature', '10m_u_component_of_wind', '10m_v_component_of_wind', 'mean_sea_level_pressure', 'total_cloud_cover', 'total_precipitation', 'toa_incident_solar_radiation']
    ...
    def load(self, air_variable, surface_variable, only_input_variable=[], static_variables=[]):
    ...
    def load_data(self, dataset:xr.Dataset, variables, static_variables) -> Tuple[torch.Tensor, torch.Tensor, torch.Tensor]:
        start = time.time()
        result = {}
