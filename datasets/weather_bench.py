...
class WeatherDataset:
    ...
    def __init__(self, start_date: datetime, end_date: datetime, device: torch.device, download_variables: List[str]):
    ...
    def check_dataset(self, start_date: datetime, end_date: datetime, download_variables: List[str]):
        idx = -1
        ...
        for resol in self.RESOLUTION:
            ...
            if not file_path.exists():
                ...
                download_zarr(gcs_path, file_path, download_variables: List[str])
