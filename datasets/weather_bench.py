...
class WeatherDataset:
    ...
    def load_data(self, dataset:xr.Dataset) -> Tuple[torch.Tensor, torch.Tensor]:
        ...
        with ThreadPoolExecutor() as executor:
            ...
            k2 = executor.submit(self.calculate_wind, v2[0][01], v2[1][0], self.device)
            futures[k2] = 0
        ...
        return torch.concat([input_dataset, input_wind_dataset], dim=1), torch.concat([target_dataset, target_wind_dataset], dim=1)
