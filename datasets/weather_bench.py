...
class WeatherDataset:
    ...
    def load_data(self, dataset:xr.Dataset) -> Tuple[torch.Tensor, torch.Tensor]:
        ...
        for i in range(wind_result[1][0].size(0) // 3):
            min_max_data.append((wind_result[1][2][0], wind_result[0][3][0]))
            min_max_data.append((wind_result[1][2][1], wind_result[0][3][1]))
            min_max_data.append((wind_result[1][2][2], wind_result[0][3][2]))
