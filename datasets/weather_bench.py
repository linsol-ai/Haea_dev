...
class WeatherDataset:
    ...
    RESOLUTION = ['1440x720', '512x256', '240x120']
    ...
    def __init__(self, year_offset: int, device: torch.device, normalize=True, offline = True, resolution=[0, 2]):
...
if __name__ == '__main__':
    ...
    weather = WeatherDataset(0, device=device, offline=True, resolution=[1])
