...
NONE_LEVEL_VARIABLE = [
  '2m_dewpoint_temperature', 'geopotential_at_surface', 'land_sea_mask', '2m_temperature', '10m_u_component_of_wind', '10m_v_component_of_wind', 'mean_sea_level_pressure', 'total_cloud_cover', 'total_precipitation'
]
