...
class LinearEncoder(nn.Module):
    def __init__(self, in_dim, mid_dim=32, dropout=0.1):
        """
        :param vocab_size: total vocab size
        :param embed_size: embedding size of token embedding
        :param dropout: dropout rate
...
class Haea(nn.Module):
    def __init__(self, var_len, dim_model, out_dim, batch_size, max_len=4*10, num_heads=12, n_encoder_layers=3, n_decoder_layers=3, dropout=0.1):
        super().__init__()
        ...
        self.encoder = LinearEncoder(dim_model, out_dim, dropout=dropout)
