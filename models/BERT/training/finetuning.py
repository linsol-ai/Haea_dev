...
config_path = os.path.join(os.path.dirname(os.path.abspath(os.path.dirname(__file__))), 'configs/fine_config.yaml')
...
def get_normal_dataset(config: FinetuningConfig):
    ...
    print(var_list)
    dataset = CustomDataset(source, config.time_len, 24)
