...
class Embedding(nn.Module):
    ...
    def forward(self, variable: torch.Tensor, pos_emb: torch.Tensor) -> torch.Tensor:
...
class Electra(nn.Module):
    ...
    def forward(self, src: torch.Tensor, var_list: torch.Tensor, src_id: torch.Tensor):
        ...
        gen_var_seq, mask_ind = self.get_var_seq(var_list, src_id, src.device)
