...
from models.ELECTRA.training.lightning import TrainingConfigFinetuningModule
...
def main(argv):
    ...
    model_pl = TrainModule(model=model, mean_std=mean_std, max_iters=max_iters, config=config.training)
