...
class HaeaVocab:
    ...
    def __init__(self, dataset: torch.Tensor, src_var_list: List[str], tgt_var_list: List[str],
        ...
        self.tgt_mask = self.get_tgt_mask(len(tgt_var_list), )
    ...
    def get_source(self, times: torch.Tensor):
        src = self.get_data(times, self.dataset)
        return src
    ...
    def get_tgt_mask(var_len, max_len) -> torch.tensor:
