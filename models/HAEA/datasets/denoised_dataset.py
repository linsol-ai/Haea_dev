...
class TimeVocab:
    ...
    def __init__(self, dataset: torch.Tensor, 
        ...
        self.src_max_len, self.src_pad = self.get_max_len(bucket_size, len(src_var_list), time_len + 2)
        self.tgt_max_len, self.tgt_pad = self.get_max_len(bucket_size, len(tgt_var_list), time_len + 2)
