...
class TimeVocab:
    ...
    def __init__(self, dataset: torch.Tensor, 
        ...
        self.src_max_len, self.src_pad = self.get_max_len(bucket_size*2, len(src_var_list), time_len)
        self.tgt_max_len, self.tgt_pad = self.get_max_len(bucket_size*2, len(tgt_var_list), time_len)
        ...
        self.mask = self.get_mask(self.src_max_len, self.src_pad)
