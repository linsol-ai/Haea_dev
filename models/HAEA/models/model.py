...
class Haea(nn.Module):
    def __init__(self, vocab: TimeVocab, in_dim: int, out_dim: int, tgt_mask: torch.Tensor, src_var_list, tgt_var_list,
    ...
    def forward(self, src: torch.Tensor, src_id: torch.Tensor, tgt: torch.Tensor, tgt_id: torch.Tensor):
        ...
        tgt_var_seq = self.get_var_seq(self.vocab.tgt_var_list, tgt_id, tgt.device)
