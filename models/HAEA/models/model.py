...
class Haea(nn.Module):
    def __init__(self, in_dim: int, out_dim: int, var_list: torch.Tensor, 
    ...
    def forward(self, src: torch.Tensor, src_id: torch.Tensor, tgt: torch.Tensor, tgt_id: torch.Tensor, tgt_mask: torch.Tensor):
        ...
        transformer_out = self.model(src, tgt, tgt_mask=.gt_mask, src_key_padding_mask=None, tgt_key_padding_mask=None)
