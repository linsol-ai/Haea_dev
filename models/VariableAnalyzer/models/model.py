...
class VariableAnalyzer(nn.Module):
    def __init__(self, var_len, src_time_len, tgt_time_len, dim_model, predict_dim, batch_size, max_len=10, num_heads=12, n_encoder_layers=3, n_decoder_layers=3, dropout=0.1):
        super().__init__()
        ...
        self.embedding = Embedding(var_len, tgt_time_len, dim_model, dropout)
