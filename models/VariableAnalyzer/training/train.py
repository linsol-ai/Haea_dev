...
FLAGS = flags.FLAGS
YEAR_OFFSET = flags.DEFINE_multi_integer('train_year', None, help='training year')
...
def _main() -> None:
    ...
    try:
        ...
        model_pl = TrainModule(model=model, config=config.training)
        ...
        train_loader = DataLoader(
            train_ds, batch_size=config.training.batch_size,    =8, shuffle=True
        )
