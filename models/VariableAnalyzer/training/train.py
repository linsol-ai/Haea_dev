...
def get_dataset(year_offset: int, time_len: int):
    ...
    return (weather.HAS_LEVEL_VARIABLE, weather.NONE_LEVEL_VARIABLE, weather.HAS_LEVEL_VARIABLE), dataset, input.shape, min_max, dims
...
def _main(args) -> None:
    ...
    try:
        ...
        dataset, shape, min_max, dims = get_dataset(train_offset, time_len)
