...
class VariableEncoder(nn.Module):
    def __init__(self, src_var_list: List[str], tgt_var_list: List[str], tgt_time_len: int, 
                 dim_model: int, out_dim: int, batch_size: int, 
        ...
        self.embedding = Embedding(max_var_len, max_time_len, dim_model, dropout)
    ...
    def forward(self, src: torch.Tensor, tgt: torch.Tensor):
        ...
        src_var_seq = torch.tensor([self.src_var_list for _ in range(self.batch_size)], device=src.device)
