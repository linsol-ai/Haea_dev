...
def get_normal_dataset(config: TrainingConfig, year_offset: int, tgt_time_len: int):
    ...
    return dataset, source.shape, mean_std, (src_var_list, tgt_var_list)
...
def _main(args) -> None:
    ...
    try:
        ...
        dataset, shape, mean_std, var_list = get_normal_dataset(config.training, train_offset, tgt_time_len)
