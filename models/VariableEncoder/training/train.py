...
def get_dataset(model_path, year_offset: int, tgt_time_len: int, latitude, longitude):
    source_vars = 
    processor = VariableProprecessor(model_path, year_offset, latitude, longitude, variables= WeatherDataset.HAS_LEVEL_VARIABLE + WeatherDataset.NONE_LEVEL_VARIABLE)
