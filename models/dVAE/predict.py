...
class VariableProprecess:
    ...
    def predict(self) -> torch.Tensor:
        ...
        mean_std_set = torch.stack(mean_std_set, dim=0)
...
if __name__ == '__main__':
    processor = VariableProprecess(WeatherDataset. + WeatherDataset.NONE_LEVEL_VARIABLE, '/workspace/Haea_dev/checkpoints/dVAE', 0)
