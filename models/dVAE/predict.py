...
class VariableProprecessor:
    def __init__(self, model_path: str, year_offset: int, latitude, longitude, variables=WeatherDataset.HAS_LEVEL_VARIABLE+WeatherDataset.NONE_LEVEL_VARIABLE, batch_size = 512):
