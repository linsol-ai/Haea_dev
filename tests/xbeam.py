...
TYPE = flags.DEFINE_integer('type', 0, help='type 0 : 1440x721, type 1 : 240x120, type 2 : 60x30')
...
def main(argv):
  ...
  OUTPUT_PATH = f'gs://era5_preprocess/{FOLDER_NAME[FLAGS.t]}/{START_DATE}_{END_DATE}.zarr'
