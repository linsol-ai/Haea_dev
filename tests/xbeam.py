...
INPUT_PATH = 'gs://weatherbench2/datasets/era5/1959-2023_01_10-6h-64x32_equiangular_conservative.zarr'
RUNNER = 'DirectRunner'
HAS_LEVEL_VARIABLE = [
...
def main(argv):
  ...
  OUTPUT_PATH = f'gs://era5_preprocess/64x32/{START_DATE}_{END_DATE}.zarr'
